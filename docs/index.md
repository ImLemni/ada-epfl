...
On one hand we have reviews, containing for example the score(referred as "overall" in the following), the review content and the user idea,
...
The first graph represents the percentage of movie reviews that mention the book per score, e.g : about 80% of scores 2 talk about the book.
...
does not tend to give better scores or reviews for a book whether they have already watched the movie or not.
